...
const Login = () => {
  ...
  return (
    <div className="w-screen h-screen md:flex justify-center items-center text-gray-800">
      <div className="flex md:justify-center  items-center bg-white w-screen h-screen">
